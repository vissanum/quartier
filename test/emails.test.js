...
describe('extractEmails', () => {
  it('ranks mailto + own-domain first and filters junk addresses', () => {
    const html = `
      <a href="mailto:info@talleresgarin.com">Escríbenos</a>
      <p>soporte@gestoria-externa.es</p>
      <img src="icon@2x.png">
      <p>noreply@newsletter.io</p>
      <p>a3f9c2d4e5b6a7f8@tracking.io</p>`;
    const out = extractEmails(html, 'https://www.talleresgarin.com');
    expect(out[0]).toBe('info@talleresgarin.com'); // mailto weight + domain affinity
